package org.example.cricbuzz.listeners;
...
public class TestReports implements IReporter {
    ...
    private String initReportTemplate() {
        ...
        byte[] reportTemplate;
        try {
            reportTemplate = Files.readAllBytes(Paths.get("C:\\Users\\Atif Rahman\\IdeaProjects\\SeleniumProject1\\test-output\\testng1reports\\reportTemplate.html"));
